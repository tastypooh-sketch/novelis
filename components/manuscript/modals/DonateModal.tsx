    ...
    return (
        <Modal onClose={onClose} settings={settings} title="Support Novelis" className="max-w-md">
            <div className="space-y-4 text-center">
                ...
                <div>
                     <a href="https://www.buymeacoffee.com/yourusername" target="_blank" rel="noopener noreferrer" className="inline-block px-6 py-3 rounded-md font-semibold" style={{backgroundColor: settings.accentColor, color: 'var(--app-text)'}}>
                        Buy Me a Coffee
                    </a>
                </div>
            </div>
