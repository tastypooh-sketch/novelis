        ...
        <div className="fixed inset-0 z-[200] flex items-center justify-center bg-black bg-opacity-90 backdrop-blur-md">
            ...
            >
                ...
                >
                    ...
                    <section className="p-4 border-l-4 border-app-danger bg-app-danger/10">
                        <h3 className="font-bold text-base mb-2 text-app-danger">2. ABSOLUTE LIMITATION OF LIABILITY</h3>
                ...
                <footer className="p-6 border-t flex flex-col sm:flex-row items-center justify-between gap-4" style={{ borderColor: settings.toolbarInputBorderColor }}>
                    ...
                    <div className="flex gap-4">
                        ...
                        <button 
                            ...
                            onClick={onAccept}
                            className="px-8 py-2 rounded font-bold shadow-lg transition-all active:scale-95 disabled:opacity-30 disabled:scale-100"
